...
export default function Expertise() {
  const [texts] = useState({
    ...
    item1Title: `React.Js Development`,
    item2Title: `Mern Stack Development`,
    item3Title: `UI/UX Designer`,
    item1: `Created beautiful UI for both mobile and web, mostly used React framework along with HTML-CSS. Experienced in developing web applications with React.js and handling frontend logic.`,
    item2: `Experienced in web development using the MERN (MongoDB, Express.js, React.js, Node.js) stack. Proficient in building full-stack web applications, handling frontend logic with React.js, and implementing backend functionality with Node.js and Express.js. Skilled in database design and integration, utilizing MongoDB to store and manage data. Capable of developing responsive and interactive web user interfaces.`,
    item3: `Passionate about UI/UX design and creating visually appealing user interfaces. Proficient in using design tools like Adobe XD or Figma to craft user-centered designs and wireframes for web and mobile applications. Skilled in creating seamless user experiences and conducting user research.`,
  });
