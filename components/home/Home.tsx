...
export default function Home() {
  const [texts] = useState({
    title: "Enso III, Jose",
    subtitle:
      "I am a Software Developer focused on drifting with the wind of newly developed tech.<br/><br/> Computer Engineer | Mern Stack Developer|<br> React.JS Developer",
  });
  return (
    <>
      <div className={`intro`}>
