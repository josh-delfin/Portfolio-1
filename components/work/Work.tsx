            ...
            <div className="content">
              <h1
                ...
                dangerouslySetInnerHTML={{
                  __html: `<strong>JJAM Event Management</strong> Website`,
                }}
              ></h1>
              <p
                style={{
              ...
              >
                JJAM Event Management is a web project I developed during my
                second-year software design class. I handled frontend
                development using HTML, CSS, and JavaScript, creating a
                user-friendly platform for managing and organizing various
                events, including event details, registrations, and scheduling.
              </p>
              <div className="box">
                <a href="https://joseensoiii.github.io/JJAM-EVENT-MANAGEMENT/">
                  {" "}
                  <button>
                    <span>Website </span>
                  </button>
          ...
          <section className="panel orange" ref={(e) => createPanelsRefs(e, 2)}>
            <div className="content">
              <h1
                ...
                dangerouslySetInnerHTML={{
                  __html: `<strong>Metacore Systems Inc. </strong> Website`,
                }}
              ></h1>
              <p
                style={{
              ...
              >
                is an innovative IT solutions company, specializing in software
                development, web applications, mobile apps, cloud computing, and
                cybersecurity. With a customer-centric approach and skilled
                team, we drive successful digital transformations, empowering
                businesses worldwide for growth and success. Experience
                technology-driven solutions with Metacore Systems Inc.
              </p>
              <div className="box">
                <a href="https://www.metacoresystemsinc.com/">
                  <button
          ...
          <section className="panel green" ref={(e) => createPanelsRefs(e, 3)}>
            <div className="content">
              <h1
                ...
                dangerouslySetInnerHTML={{
                  __html: `<strong>Oneluxor</strong> Website`,
                }}
              ></h1>
              <p
                style={{
              ...
              >
                OneLuxor is a dedicated travel website that invites you to
                embark on a captivating journey through the mesmerizing
                destinations of the Philippines. Immerse yourself in the allure
                of this tropical paradise as we unveil a curated selection of
                the country's most alluring and unique destinations.
              </p>
              <div className="box">
                <a href="https://www.oneluxor.ph/">
                  <button
          ...
          <section className="panel purple" ref={(e) => createPanelsRefs(e, 4)}>
            <div className="content">
              <h1
                ...
                dangerouslySetInnerHTML={{
                  __html: `<strong>Philippine Property Homes</strong> POS`,
                }}
              ></h1>
              <p
                style={{
              ...
              >
                Point of Sale (POS) system simplifies and manages all
                transactions entering and leaving your company, ensuring
                streamlined financial operations. Trust in our secure and
                efficient POS to optimize your business processes and drive
                success.
              </p>
              <div className="box">
                <a href="#">
            ...
            >
              <h1
                ...
                dangerouslySetInnerHTML={{
                  __html: `<strong>Philip Rice Dealer</strong> POS`,
                }}
              ></h1>
              <p
                style={{
              ...
              >
                rice dealership with our specialized Point of Sale (POS) system.
                Effortlessly manage inventory, track sales, and ensure accurate
                measurements with integrated scales. Elevate your business and
                optimize efficiency with our technology-driven solution.
              </p>
              <div className="box">
                <a href="#">
          ...
          <section className="panel gray" ref={(e) => createPanelsRefs(e, 5)}>
            <div className="links">
              <h1
                style={{ color: "#bae374" }}
                dangerouslySetInnerHTML={{
                  __html: `<strong>Checkout more</strong> `,
                }}
              ></h1>
              <div className="box2">
                <a href="https://github.com/JoseEnsoIII">
                  <button>
                    <span>Github</span>
                  </button>
                </a>
      ...
      <style jsx>{`
        * {
        ...
        .red {
          ...
          background-image: url(img/metacore.png);
        }
